...
- Caso queira encaminhar mensagens de um chat de uma conversa com outra pessoa, insira no campo "ORIG" o nome completo do usuário. Caso ocorra algum erro, tente inserir no lugar do nome a ID do usuário.
